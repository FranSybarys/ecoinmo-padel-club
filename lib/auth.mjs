...
// hawkings.education entra para que los socios de Hawkings puedan ver
// el trabajo publicado en su espacio de Vercel.
const DOMINIOS = ['ecoinmo.com', 'hawkings.education'];
...
export function emailValido(email) {
  ...
  return DOMINIOS.some(d => e.endsWith('@' + d)) ? e : null;
}
